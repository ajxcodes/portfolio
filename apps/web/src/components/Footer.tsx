        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3">
          ...
          {!isAdminPath && (
            <Link
              ...
              className="p-1 ml-1 text-primary/40 hover:text-primary hover:bg-primary/5 rounded border border-transparent hover:border-primary/20 transition-all duration-300"
            >
              <svg
