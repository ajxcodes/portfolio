  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center gap-4 border-b border-primary/10 pb-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-primary font-mono">new_post</h1>
          <p className="text-xs text-muted-foreground/80 mt-0.5">Create a new developer log entry</p>
        </div>
      </div>
