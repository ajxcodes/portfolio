          ...
          {experiences.length === 0 ? (
            ...
            <div className="space-y-6">
              {experiences.map((exp, index) => (
                <div 
                  key={index}
                  className="p-5 border border-primary/20 bg-primary/5 rounded-md space-y-4 relative"
                >
                  {/* Actions Bar */}
                  ...
                  <h3 className="font-bold text-xs text-foreground/80 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 bg-background border border-primary/20 rounded-md text-xs"
                        placeholder="Google"
                      />
                    </div>
